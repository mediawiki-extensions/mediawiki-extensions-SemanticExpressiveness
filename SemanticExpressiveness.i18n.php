...
$messages['hsb'] = array(
	...
	'semex-shortquery-hover-loading-failed' => 'Začitowanje wobsaha cilowych stronow krótkich naprašowanjow je so njeporadźiło.', # Fuzzy
	'semex-shortquery-error-missing-property' => 'Za naprašowanu kajkosć njeje so žana hódnota definowała.',
	'semex-shortquery-error-byref-has-many-values' => 'Podata referencna kajkosć ma wjace hač jednu hódnotu, jenož prěnja je so jako cil naprašowanja wužiła.', # Fuzzy
...
$messages['it'] = array(
	...
	'semex-shortquery-hover-loading-failed' => "Caricamento non riuscito della pagina di destinazione dell'interrogazione breve.", # Fuzzy
	'semex-shortquery-error-missing-property' => 'Nessun valore definito per la proprietà interrogata.',
	'semex-shortquery-error-byref-has-many-values' => "La proprietà di riferimento indicata ha più di un valore, solo il primo è stato considerato per l'interrogazione.", # Fuzzy
...
$messages['sv'] = array(
	...
	'semex-shortquery-hover-loading-failed' => 'Det gick inte att läsa in de korta frågornas målsidor.', # Fuzzy
	'semex-shortquery-error-missing-property' => 'Inget värde har definierats för den efterfrågade egenskapen.',
	'semex-shortquery-error-byref-has-many-values' => 'Den givna referensegenskapen har mer en ett värde, endast den första valdes som mål för frågan.', # Fuzzy
