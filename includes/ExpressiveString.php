...
class ExpressiveString {
	...
	/**
	 * All parts the original string consists of
	 * @var ExpressiveStringPiece[]
	 */
	 ...
	 * 
	 * @param ExpressiveStringOutputOptions|null $defaultOption allows to set a option used as
	 *        default. If set to null the piece types own default options will be used.
	 * @param ExpressiveStringOutputOptions|ExpressiveStringOutputOptions[]|null[]|null
	 *        $options If one option is given, it will be taken for all types of pieces, otherwise
	 *        an array is expected which holds keys which refer to certain piece types to define
	 *        a certain option per type. If the value for one type is set to null, it will fall
	 *        back to its default option. If a type is completely omitted, the $defaultOption will
	 *        be used for the type, except it is set to null, in this case the types default
	 *        option will be used.
	 * 
	 * @return string
	 */
	 ...
	 * of the type when parsing. The highest will be initialized last during the parser process.
	 * 
	 * @return array 
	 */
